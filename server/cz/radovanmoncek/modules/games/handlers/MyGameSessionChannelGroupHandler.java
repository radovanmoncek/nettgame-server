...
import cz.radovanmoncek.modules.games.events.MyGameSessionEventListener;
...
public class MyGameSessionChannelGroupHandler extends GameSessionChannelGroupHandler<Request> {
    @SuppressWarnings("unused")
    @ChannelHandlerAttributeInjectee
    private GameHistories gameHistories;
    private static final Logger logger = Logger.getLogger(MyGameSessionChannelGroupHandler.class.getName());
    ...
    protected void channelRead0(final ChannelHandlerContext channelHandlerContext, final Request gameStateRequest) {
        ...
        switch (gameStateRequest.gameStatus()) {
            ...
            case GameStatus.START_SESSION -> {
                ...
                startGameSession(new MyGameSessionEventListener(playerChannel, gameHistories), List.of(new AbstractMap.SimpleEntry<>(GameSessionConfigurationOption.MAX_PLAYERS, 2)));
            }
