...
public class MyGameSessionEventListener extends GameSessionEventListener {
    private static final Logger logger = Logger.getLogger(MyGameSessionEventListener.class.getName());
    ...
    public MyGameSessionEventListener(Channel hostChannel, GameHistories gameHistories) {
    ...
    public void onContextConnectionsEmpty(GameSessionContext context) {
        ...
        orderedPlayerChannels[0] = null;
        orderedPlayerChannels[1] = null;
