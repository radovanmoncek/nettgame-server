...
*This analysis was, originaly, a part of my Bachelor's thesis, but was ultimately cut due to insufficient data. 
For this reason, its entirety is written in Czech, my native language.*
...
Výzkum byl proveden pomocí zasílání požadavků a odpovědí mezi dvěma síťovými hosty, dále subjekty, klientem a serverem. Oba subjekty jsou platformami poháněnými procesorem AMD a operačním systémem Windows NT. Propojení mezi subjekty tvořil tzv. „domácí router“, přepínač 2. vrstvy (L2), ethernetový a bezdrátový spoj. 

Je ale axiomaticky známo, že rychlost spojení mezi dvěma a více síťovými hosty je omezena rychlostí nejpomalejšího článku tohoto spojení.
...
- jsou zadány požadované údaje pro spuštění herní relace
- a poté je provedeno 60 konsekutivních pohybů zvolených pseudonáhodným generátorem programovacího jazyka Java *Random*.
...
![První průběh běhu v rámci .jar artefaktu](https://github.com/radovanmoncek/nettgame-server/blob/development/metrics/jar_test_1_source_client_WireShark.png)
...
![Druhý průběh výzkumu běhu v rámci .jar artefaktu](https://github.com/radovanmoncek/nettgame-server/blob/development/metrics/jar_test_2_source_client_WireShark.png)
...
![První průběh běhu herního serveru v izolaci Docker kontejneru](https://github.com/radovanmoncek/nettgame-server/blob/development/metrics/docker_test_1_source_client_WireShark.png)
...
![Druhý průběh pokusu s využitím Docker kontejneru jako běhového prostředí herního serveru](https://github.com/radovanmoncek/nettgame-server/blob/development/metrics/docker_test_2_source_client_WireShark.png)
